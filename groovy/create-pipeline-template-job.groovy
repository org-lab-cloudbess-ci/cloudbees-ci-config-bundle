...
if (configOpsJob == null) {
  ...
  SCMSource scm = new GitSCMSource("https://github.com/org-lab-cloudbess-ci/pipeline-template-catalog.git");
      ...
      <instance>
        ...
        <values class="tree-map">
          ...
          <entry>
            ...
            <string>org-lab-cloudbess-ci</string>
          </entry>
          <entry>
        ...
        <data>
          <jenkins.branch.BranchSource>
            <source class="org.jenkinsci.plugins.github_branch_source.GitHubSCMSource" plugin="github-branch-source@2.8.3">
              ...
              <repoOwner>org-lab-cloudbess-ci</repoOwner>
              <repository>pipeline-template-catalog</repository>
              <repositoryUrl>https://github.com/org-lab-cloudbess-ci/pipeline-template-catalog.git</repositoryUrl>
              <traits>
